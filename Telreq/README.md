...
#### 📞 電話との自然連携強化
- [ ] **自動アプリ立ち上がり**: 着信時にTelreqアプリが自動起動
- [ ] **シームレス統合**: 標準電話アプリとの完全同期
- [ ] **バックグラウンド最適化**: 電話アプリ使用中の自動録音改善

#### 🎨 履歴UIの大幅改善  
- [ ] **モダンデザイン**: iOS標準に準拠した洗練されたUI
- [ ] **検索・フィルタ機能**: 日付・参加者・タグによる高速検索
- [ ] **要約プレビュー**: リスト表示での要約内容プレビュー
- [ ] **タグ管理**: カスタムタグ・カテゴリ分類システム
- [ ] **エクスポート機能**: PDF・CSV・メール共有
